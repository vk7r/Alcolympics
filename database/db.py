...
def add_player(name, klunkar_druckna=0, klunkar_givna=0, Ws=0, Ls=0):
...
def update_player(name, date=None, klunkar_druckna=None, klunkar_givna=None, Ws=None, Ls=None):
...
def increment_stats(name, klunkar_druckna=0, klunkar_givna=0, Ws=0, Ls=0, date=None):
...
def reset_player_stats(name, date=None):
    ...
    return update_player(name, date, klunkar_druckna=0, klunkar_givna=0, Ws=0, Ls=0)
...
def total_stats_for_player(name):
    ...
    totals = {"klunkar_druckna": 0, "klunkar_givna": 0, "Ws": 0, "Ls": 0}
    for p in entries:
...
def show_all_time_goat():
    """Returns the players who's the all time GOAT"""
    players = {}
    for entry in db.all():
        name = entry["name"]
        players[name] = players.get(name, 0) + entry["klunkar_druckna"]
